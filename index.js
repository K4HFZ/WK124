...
autoketik = false;
prefixStatus = true;
targetpc = "6281365814200"; //Ganti No Lu
owner = "6281365814200"; //Ganti No Lu 
fakeyoi = "ASEYOU BOTZ"; //Ganti Nama Lo
HunterApi = "Ikyy69", //Jan Di Ganti
valkey = "rivalgans", //Jan Di Ganti Karna Apikey
dapapi = "itsmevall", //Jan Di Ganti
nomorowner1 = "@6281365814200"; //Ganti No Lo
...
const fakeitem = (teks) => {
        ...
        participant:`0@s.whatsapp.net`, ...(from ? {
remoteJid :"6289523258649-1604595598@g.us" }: {})
                    },message:{"orderMessage":{"orderId":"174238614569481","thumbnail":fs.readFileSync(`./stik/thumb.jpeg`),"itemCount":10,"status":"INQUIRY","surface":"CATALOG","message":`KiriGiri`,"token":"AR6xBKbXZn0Xwmu76Ksyd7rnxI+Rx87HfinVlW4lwXa6JA=="}}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true})}
const katalog = (teks) => {
             res = itsmevall.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*KiriGiri*", "thumbnail": iye, "surface": 'CATALOG' }}, {quoted:mek})
...
sendEphemeral: false,
"externalAdReply": {
                "title": `Whatsapp-Bot\nK I R I G I R I. (@KiriGiri) •Instagram photos and Videos`,
                "body": "",
                "previewType": "PHOTO",
...
"externalAdReply": {
                "title": `Whatsapp`,
                "body": `wa.me/6282284568556`,
                "mediaType": "10",
                "mediaUrl": `wa.me/6282284568556`,
                "thumbnailUrl": "https://d.top4top.io/p_2079h2l7v0.jpeg",
                "thumbnail": iye,
                "sourceUrl": `wa.me/6282284568556`,
...
async function sendFileFromUrl(from, url, caption, msg, men) {
    ...
    if (isGroup && isAntivirtex && !mek.key.fromMe) {
      if (budy.length > 700) {
        if (isGroupAdmins) return reply("admin bebas");
        reply("ANTIVIRTEX DETECTED!! MAAF ANDA AKAN DIKICK ;V AWOWMWOWK");
        itsmevall.groupRemove(from, sender);
      }
    }
...
case 'menu':
       txtt =`Hai Kak ${pushname}\nPilih Opsi Dibawah Ini Ya.. `
               ...
               {buttonId:`${prefix}status`,buttonText:{displayText:'STATUS BOT ASU4YOU🛠️'},type:1},
               {buttonId:`${prefix}owner`,buttonText:{displayText:'OWNER GANTENG✗⃝🐣'},type:1}]
        ...
        *INFO OWNER*
❍ NAMA OWNER : ${fakeyoi}
❍ NO OWNER : +6281365814200
❍ UMUR : vrifasi TH
❍ ASAL : BANDUNG KOTA KEMBANG

         *「INFO BOT」*
❍ NAMA BOT : ASY4YOU BOTZ
❍ NO OWNER : +6281365814200
...
case 'laporan': //KIRIGIRI
       reply('*HALO  KACK ADA MASALAH APA DENGAN BOT NYA KAK SI LAHKAN CHAT OWNER/DEVELOPER BOT wa.me/6281365814200*')
        sendButMessage(from, `Hai Kak ${pushname} 🐤`, `Kalo Nemu Bug Sung Kasih Tau Owner 🐣`, [
          {
        ...
        case 'remake1':
          ...
          case 'remake2':
            ...
            break
            case 'remake3':
              reply('ASU4YOUBot Mengunakan Sc : https://github.com/K4HFZ')
              break
...
break
      /*case "owner":
        sendKontak(from, owner, "ASE4YOU", "Sibuk");*/
case 'owner':
           case 'creator':
...
break
case 'nuliskanan':
if (!c) return reply('Textnya mana bang:v?')
reply(mess.wait)
...
break
case 'foliokanan':
if (!c) return reply('Textnya mana woii?')
reply(mess.wait)
...
itsmevall.sendMessage(from, stdout, text, term)
      ...
      default:
		if (hour_now >= '02:00' && hour_now <= '04:00') {
          console.log(color('[Pesan Bot]', 'cyan'), color('Waktunya tidur kak, Main botnya buat nanti lagi, Sebelum tidur jangan lupa baca Doa ya kak', 'yellow'), color('(😊)', 'white'))
          }
        ...
        if (hour_now >= '19:00' && hour_now <= '20:00') {
           console.log(color('[Pesan Bot]', 'cyan'), color('Bentar lagi jam 8 kak, Yok kak main botnya buat nanti lagi, Sekarang siap-siap dulu buat Sholat ISYA', 'yellow'), color('(😊)', 'white'))
           }
        if (hour_now >= '20:00' && hour_now <= '00:00') {
          ...
          if (hour_now >= '00:00' && hour_now <= '02:00') {
           console.log(color('[Pesan Bot]', 'cyan'), color('ASU4YOUBot ngantuk kak, tidur dulu ya kak', 'yellow'), color('(😴)', 'white'))
        }
